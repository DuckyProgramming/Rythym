maps=[
    {
        ...
        '22220642220642077764286666554206554206554206554206554206554206554'+
...
stage={scale:0,focus:{x:0,y:0,size:1},cube:{x:0,y:0},map:5,scene:'level'}
gameplay={range:45,speed:5}
